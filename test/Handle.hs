...
logHandleSpec = Logger.Handle {Logger.hLowLevelLog = \_ _ -> return ()}

-- AppConfigLimit appShowLimit = 3 for testing offset
appConfigSpec :: AppConfig
appConfigSpec = AppConfig {appPort = 8080, appShowLimit = 3}
...
appConfigSpecForLimit = AppConfig {appPort = 8080, appShowLimit = 100}
...
uRIConfigSpec =
  News.URIConfig
    {News.uriScheme = Http, News.uriHost = "localhost", News.uriPort = 8080}
