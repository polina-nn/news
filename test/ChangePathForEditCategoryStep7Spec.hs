...
module ChangePathForEditCategoryStep7Spec
  ( spec
  ) where
...
spec =
  describe
    "Category.changePathsForEditCategory. Vahram Olegovich Sargsyan - Ivanov move one level deeper" $ do
    it "Step1:" $
...
categoryAfterStepOne =
  [ DataTypes.Category {categoryPath = "0", categoryId = 9, categoryName = ""}
  ...
  , DataTypes.Category
      {categoryPath = "3.3.1", categoryId = 13, categoryName = ""}
...
categoryAfterStepFour =
  ...
  , DataTypes.Category
      {categoryPath = "3.3.1", categoryId = 13, categoryName = ""}
  , DataTypes.Category
      {categoryPath = "3.3.1.1", categoryId = 9, categoryName = ""}
  , DataTypes.Category {categoryPath = "3.4", categoryId = 1, categoryName = ""}
  , DataTypes.Category {categoryPath = "4", categoryId = 3, categoryName = ""}
  , DataTypes.Category {categoryPath = "5", categoryId = 4, categoryName = ""}
  , DataTypes.Category {categoryPath = "6", categoryId = 10, categoryName = ""}
...
editCategoryRequests =
  Just [CategoryHelpTypes.EditCategory {_id = 9, newPath = "3.3.1.1"}]
