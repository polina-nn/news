...
spec =
  describe
    "Category.changePathsForEditCategory. Vahram Olegovich Sargsyan - Ivanov move one level deeper"
    $ do
      it "Step1:" $
...
editCategoryRequests =
  Just [CategoryHelpTypes.EditCategory {permanentId = 9, newPath = "3.3.1.1"}]
