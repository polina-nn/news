...
module СhangePathForEditCategStep1Spec
  ( spec,
  )
where
...
spec :: Spec
spec = describe "Category.changePathsForEditCateg. Move Vagram Feliksovich to the second level after Vagram Olegovich " $ do
  it "Step1:" $
...
categoryAfterStepOne =
  [ DataTypes.Category {category_path = "0", category_id = 1, category_name = ""},
    ...
    DataTypes.Category {category_path = "5", category_id = 5, category_name = ""},
    DataTypes.Category {category_path = "5.1", category_id = 6, category_name = ""},
    DataTypes.Category {category_path = "5.2", category_id = 7, category_name = ""},
    DataTypes.Category {category_path = "5.2.1", category_id = 8, category_name = ""},
    DataTypes.Category {category_path = "5.2.2", category_id = 9, category_name = ""},
    DataTypes.Category {category_path = "6", category_id = 10, category_name = ""},
    DataTypes.Category {category_path = "7", category_id = 11, category_name = ""},
    DataTypes.Category {category_path = "8", category_id = 12, category_name = ""},
    DataTypes.Category {category_path = "9", category_id = 13, category_name = ""}
  ]
...
categoryAfterStepTwo =
  [ DataTypes.Category {category_path = "0", category_id = 1, category_name = ""},
    ...
    DataTypes.Category {category_path = "4", category_id = 5, category_name = ""},
    DataTypes.Category {category_path = "4.1", category_id = 6, category_name = ""},
    DataTypes.Category {category_path = "4.2", category_id = 7, category_name = ""},
    DataTypes.Category {category_path = "4.2.1", category_id = 8, category_name = ""},
    DataTypes.Category {category_path = "4.2.2", category_id = 9, category_name = ""},
...
categoryAfterStepFour =
  [ DataTypes.Category {category_path = "1", category_id = 2, category_name = ""},
    ...
    DataTypes.Category {category_path = "4.2.1", category_id = 8, category_name = ""},
    DataTypes.Category {category_path = "4.2.2", category_id = 9, category_name = ""},
    DataTypes.Category {category_path = "4.3", category_id = 1, category_name = ""},
    DataTypes.Category {category_path = "5", category_id = 10, category_name = ""},
    DataTypes.Category {category_path = "6", category_id = 11, category_name = ""},
    DataTypes.Category {category_path = "7", category_id = 12, category_name = ""},
    DataTypes.Category {category_path = "8", category_id = 13, category_name = ""}
...
editCategoryRequests =
  Just
    [ CategoryHelpTypes.EditCategory {_id = 1, new_path = "4.3"},
      CategoryHelpTypes.EditCategory {_id = 2, new_path = "1"},
      CategoryHelpTypes.EditCategory {_id = 3, new_path = "2"},
      CategoryHelpTypes.EditCategory {_id = 4, new_path = "3"},
      CategoryHelpTypes.EditCategory {_id = 5, new_path = "4"},
      CategoryHelpTypes.EditCategory {_id = 6, new_path = "4.1"},
      CategoryHelpTypes.EditCategory {_id = 7, new_path = "4.2"},
      CategoryHelpTypes.EditCategory {_id = 8, new_path = "4.2.1"},
      CategoryHelpTypes.EditCategory {_id = 9, new_path = "4.2.2"},
      CategoryHelpTypes.EditCategory {_id = 10, new_path = "5"},
      CategoryHelpTypes.EditCategory {_id = 11, new_path = "6"},
      CategoryHelpTypes.EditCategory {_id = 12, new_path = "7"},
      CategoryHelpTypes.EditCategory {_id = 13, new_path = "8"}
    ]