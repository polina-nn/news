...
module ChangePathForEditCategoryStep5Spec
  ( spec
  ) where
...
spec =
  describe
    "Category.changePathsForEditCategory. STEP5 Move Anna Borisovna to Anna's children" $ do
    it "Step1:" $
...
categoryAfterStepOne =
  [ DataTypes.Category {categoryPath = "0", categoryId = 8, categoryName = ""}
