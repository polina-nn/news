...
spec =
  describe
    "Category.changePathsForEditCategory. Move Vahram Oleg Sargsyan one level down after Vahram Olegovich" $ do
    it "Step1:" $
...
categoryAfterStepOne =
  ...
  , DataTypes.Category
      {categoryPath = "3.3.1", categoryId = 9, categoryName = ""}
...
editCategoryRequests =
  Just
    ...
    , CategoryHelpTypes.EditCategory {_id = 13, newPath = "3.3.1"}
    ]
