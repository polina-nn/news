...
authorsNewsList _ (h, user, f, mSort, mo, ml) = do
  ...
  case resAllCheck of
    ...
    Right (offset, limit, dbFiler) -> do
      Logger.logDebug (News.hLogHandle h) $ T.concat [T.pack "All Check: OK!  \n"]
        ...
        Right conn -> do
          ...
          case News.checkErrorsToNews news res of
            (True, news') -> do
              ...
              Logger.logInfo (News.hLogHandle h) $ T.concat [T.pack "authorsNewsList: OK! \n", toTextNews]
